...
public class ResponseUnReservedSchema {
  ...
  @javax.annotation.Nullable
  private List<ResponseUnReservedSchemaDataInner> data = new ArrayList<>();

  public ResponseUnReservedSchema() {
  }

  public ResponseUnReservedSchema success(@javax.annotation.Nullable Boolean success) {
  ...
  public ResponseUnReservedSchema returnCode(@javax.annotation.Nullable String returnCode) {
  ...
  public ResponseUnReservedSchema messageEn(@javax.annotation.Nullable String messageEn) {
  ...
  public ResponseUnReservedSchema messageVi(@javax.annotation.Nullable String messageVi) {
  ...
  public ResponseUnReservedSchema usedStore(@javax.annotation.Nullable ResponseReservedSchemaUsedStore usedStore) {
  ...
  public ResponseUnReservedSchema billNumber(@javax.annotation.Nullable String billNumber) {
  ...
  public ResponseUnReservedSchema data(@javax.annotation.Nullable List<ResponseUnReservedSchemaDataInner> data) {
    this.data = data;
    return this;
  }

  public ResponseUnReservedSchema addDataItem(ResponseUnReservedSchemaDataInner dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ResponseUnReservedSchemaDataInner> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<ResponseUnReservedSchemaDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResponseUnReservedSchema responseUnReservedSchema = (ResponseUnReservedSchema) o;
    return Objects.equals(this.success, responseUnReservedSchema.success) &&
        Objects.equals(this.returnCode, responseUnReservedSchema.returnCode) &&
        Objects.equals(this.messageEn, responseUnReservedSchema.messageEn) &&
        Objects.equals(this.messageVi, responseUnReservedSchema.messageVi) &&
        Objects.equals(this.usedStore, responseUnReservedSchema.usedStore) &&
        Objects.equals(this.billNumber, responseUnReservedSchema.billNumber) &&
        Objects.equals(this.data, responseUnReservedSchema.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResponseUnReservedSchema {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResponseUnReservedSchema
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseUnReservedSchema.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseUnReservedSchema is not found in the empty JSON string", ResponseUnReservedSchema.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResponseUnReservedSchema.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseUnReservedSchema` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ResponseUnReservedSchemaDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseUnReservedSchema.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseUnReservedSchema' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseUnReservedSchema> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseUnReservedSchema.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseUnReservedSchema>() {
           @Override
           public void write(JsonWriter out, ResponseUnReservedSchema value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseUnReservedSchema read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResponseUnReservedSchema given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResponseUnReservedSchema
   * @throws IOException if the JSON string is invalid with respect to ResponseUnReservedSchema
   */
  public static ResponseUnReservedSchema fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseUnReservedSchema.class);
  }

  /**
   * Convert an instance of ResponseUnReservedSchema to an JSON string
   *
   * @return JSON string
   */
